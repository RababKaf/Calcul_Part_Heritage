...
public class MvcConfig implements WebMvcConfigurer {
    ...
    public void addViewControllers(final ViewControllerRegistry registry) {
       ...
       // registry.addViewController("/profile").setViewName("Admin/profile");
        ...
        registry.addViewController("/ClientProfessionnel/index").setViewName("ClientProfessionnel/index");
        registry.addViewController("/index").setViewName("index");
        registry.addViewController("Admin/index").setViewName("Admin/index");
        registry.addViewController("/contact").setViewName("contact");
        registry.addViewController("/login");
        registry.addViewController("/calcul*").setViewName("ClientProfessionnel/resultatPro");
    ...
    public LocaleResolver localeResolver(){
        ...
        localeResolver.setDefaultLocale(new Locale("ar", "DZ"));
